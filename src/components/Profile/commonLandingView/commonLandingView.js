             ...
             <div className="commonLandingView_main">
                 ...
                 <AllUserSelect
                     ...
                     showHeaderButtons={[{ id: "edit", label:  `Edit ${viewTypeFirstLetterCapital} Profile` },
                         ...
                         !(viewType === "tracking") ? { id: "duplicate", label: `Duplicate ${viewTypeFirstLetterCapital} Profile` } : {}]}
                     ...
                     onClickUserDelete={() => this.setState({ visibilityOfConfirmationPopUp: true, typeOfActionOnProfile: "delete" })}
                     onClickUserEdit={() => this.onClickProfileLandingViewActions("edit")}
                     onClickUserDuplicate={() => this.setState({ visibilityOfConfirmationPopUp: true, typeOfActionOnProfile: "duplicate" })}
