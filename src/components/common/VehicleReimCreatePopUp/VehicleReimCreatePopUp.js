...
class VehicleReimCreatePopUp extends Component {
    ...
    getInputSkeleton = (ele) => {
        ...
        return <div className={'field-wrap'}>
            ...
            <Input placeholder={ele.placeholder} prefix={prefix} className={'preferred-field-class'} onChange={this.onLeaveTypeChange}/>
        </div>
    };
    ...
    render() {
        ...
        let input = [
            ...
            {header: 'Max KM can be claimed', placeholder: 'Enter KM', prefix: false,function: (value) => this.onLeaveTypeChange(value)},
