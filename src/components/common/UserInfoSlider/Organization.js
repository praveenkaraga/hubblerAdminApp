            ...
            return map(this.props.clickedUserOrgReporteesData, ele => <div className={'user-template'}>
                ...
                <div className={'user-template-details'}>
                    ...
                    <div className={'designation-id-wrap'}>
                        <div
                            className={'user-template-designation'}>{ele.designations ? ele.designations.length ? ele.designations[0].name : '' : ''}</div>
...
*/
    render() {
        const {clickedUserOrgManagerData, clickedUserOrgReporteesData, total_Count} = this.props
